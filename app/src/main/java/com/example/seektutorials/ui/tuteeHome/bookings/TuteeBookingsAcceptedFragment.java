...
public class TuteeBookingsAcceptedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tutee_bookings_accepted, null);
        ...
        final FirestoreRecyclerAdapter<Session, TuteeBookingsAcceptedFragment.BookingsViewHolder> adapter = new FirestoreRecyclerAdapter<Session, TuteeBookingsAcceptedFragment.BookingsViewHolder>(options) {
            @Override
            public void onBindViewHolder(TuteeBookingsAcceptedFragment.BookingsViewHolder holder, int position, Session model) {
            ...
            @Override
            public TuteeBookingsAcceptedFragment.BookingsViewHolder onCreateViewHolder(ViewGroup group, int i) {
